...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('Ⓜ︎Ⓞ︎Ⓥ︎Ⓘ︎Ⓔ︎Ⓢ︎', url=f'https://t.me/{SUPPORT_CHAT}')
            ],[
            InlineKeyboardButton('Ⓗ︎Ⓔ︎Ⓛ︎Ⓟ︎', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("Ⓜ︎Ⓞ︎Ⓥ︎Ⓘ︎Ⓔ︎Ⓢ︎", url="https://t.me/CCG_LINKS")
            ],[      
            InlineKeyboardButton("Ⓗ︎Ⓔ︎Ⓛ︎Ⓟ︎", callback_data="help"),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton("Ⓗ︎Ⓔ︎Ⓛ︎Ⓟ︎", callback_data="help"),
            InlineKeyboardButton("Ⓐ︎Ⓑ︎ⓄⓊ︎Ⓣ︎", callback_data="about")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_chat_action(enums.ChatAction.TYPING)
        m=await message.reply_sticker("CAACAgUAAxkBAAIFNGJSlfOErbkSeLt9SnOniU-58UUBAAKaAAPIlGQULGXh4VzvJWoeBA")
